...
export class FilterPedido {
    ...
    static create( props: {[key: string]: any} ): [string?, FilterPedido?] {
        const { fechaCambio, usuarioIngresa, estado,nombreUsuario,correoUsuario,telefonoUsuario,documentoUsuario,direccionUsuario,
            fechaEntrega, Total } = props;
        

        return [undefined, new FilterPedido(fechaCambio,usuarioIngresa,estado,nombreUsuario,correoUsuario,telefonoUsuario,documentoUsuario,direccionUsuario
            ,fechaEntrega,Total)];
    }
}